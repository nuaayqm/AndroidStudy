...
import com.alibaba.mychatgpt.constant.OpenAIConst;
import com.alibaba.mychatgpt.entity.chat.ChatCompletion;
import com.alibaba.mychatgpt.entity.chat.ChatCompletionResponse;
import com.alibaba.mychatgpt.entity.chat.Message;
import com.alibaba.mychatgpt.entity.common.DeleteResponse;
import com.alibaba.mychatgpt.entity.common.OpenAiResponse;
import com.alibaba.mychatgpt.entity.completions.Completion;
import com.alibaba.mychatgpt.entity.completions.CompletionResponse;
import com.alibaba.mychatgpt.entity.edits.Edit;
import com.alibaba.mychatgpt.entity.edits.EditResponse;
import com.alibaba.mychatgpt.entity.embeddings.Embedding;
import com.alibaba.mychatgpt.entity.embeddings.EmbeddingResponse;
import com.alibaba.mychatgpt.entity.engines.Engine;
import com.alibaba.mychatgpt.entity.files.File;
import com.alibaba.mychatgpt.entity.files.UploadFileResponse;
import com.alibaba.mychatgpt.entity.fineTune.Event;
import com.alibaba.mychatgpt.entity.fineTune.FineTune;
import com.alibaba.mychatgpt.entity.fineTune.FineTuneResponse;
import com.alibaba.mychatgpt.entity.images.*;
import com.alibaba.mychatgpt.entity.models.Model;
import com.alibaba.mychatgpt.entity.models.ModelResponse;
import com.alibaba.mychatgpt.entity.moderations.Moderation;
import com.alibaba.mychatgpt.entity.moderations.ModerationResponse;
import com.alibaba.mychatgpt.entity.whisper.Whisper;
import com.alibaba.mychatgpt.entity.whisper.WhisperResponse;
...
public class OpenAiClient {
    private final static String TAG = "com.alibaba.mychatgpt.OpenAiClient";
    /**
     * keys
     */
    @Getter
        ...
        client.addInterceptor(chain -> {
            ...
            if (!response.isSuccessful()) {
                if (response.code() == CommonError.OPENAI_AUTHENTICATION_ERROR.code()
                    ...
                    Log.e(TAG, openAiResponse.getError().getMessage());
                    throw new BaseException(openAiResponse.getError().getMessage());
                }
                String errorMsg = response.body().string();
                Log.e(TAG,"请求异常：{}" + errorMsg);
...
//    }
    ...
    private void checkSpeechFileSize(java.io.File file) {
        if (file.length() > 25 * 1204 * 1024) {
            Log.w(TAG,"2023-03-02官方文档提示：文件不能超出25MB");
        }
    }
    ...
    public static final class Builder {
         ...
         * api请求地址，结尾处有斜杠
         *
         * @see com.alibaba.mychatgpt.constant.OpenAIConst
         */
